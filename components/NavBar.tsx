...
export default function Navbar() {
  ...
  return (
    <>
          ...
          <div className="hidden md:flex items-center gap-2">
            {navItems.map((item) => {
              ...
              return (
                <div key={item.href} className="relative">
                  ...
                  >
                    <span className={`text-sm ${active ? "text-blue-400" : "text-zinc-500 group-hover:text-blue-400"}`}>
                      {item.icon}
                    </span>
            ...
            <div className="relative ml-2">
              ...
              >
                ...
                <span className="ml-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform group-hover:translate-x-1">→</span>
      ...
      >
        <div 
          className="px-4 py-6 h-full overflow-y-auto"
